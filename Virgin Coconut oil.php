                        ...
                        <div class="pt-5">
                            <div class="mb-6 grid gap-8 xl:grid-cols-3">
                                <div class="panel h-full xl:col-span-2">
                                    ...
                                    ?>
                                    <div id="hide">
                                        <input type="text" name="val" id="divisorInput" value="<?php echo $row['vco']; ?>" placeholder="" class="form-input" onchange="calculateColumns()"/>
                                    </div>                                    
                                    ...
                                    $vol8=($four/(700 * 3.6));
                                    $fix8=($vol8/120);
                                    $jetone=mysqli_query($db,"INSERT INTO so (one, two, three, four, vol1, fix1, vol2, fix2, vol3, fix3, vol4, fix4, vol5, fix5, vol6, fix6, vol7, fix7, vol8, fix8) VALUES('$one', '$two', '$three', '$four','$vol1', '$fix1', '$vol2', '$fix2', '$vol3', '$fix3', '$vol4', '$fix4', '$vol5', '$fix5', '$vol6', '$fix6', '$vol7', '$fix7', '$vol8', '$fix8')");                                                 
                                    }
                                    ?>
                                ...
                                <div class="panel h-full">
                                    ...
                                    <div class="overflow-hidden" style="Overflow-y:scroll; height: 300px;">
                                        <b>1.</b> Cloth suggested HP PO 600 GSM and for higher clarity HP 800 GSM<br><br>

                                        <b>2.</b> Pump selection shall be 5 times the chamber volume . For example 500 liters is chamber volume then 500*5= 2500 so 2.5 m3/hr pump shall be  suggested, progressive screw pump can be given <br><br> 

                                        <b>3.</b> Check with customer if the machine MOC required is SS 304 or  if the MOC required is SS cladding on entire machine structure or MOC required is SS 304 only for Launder and Nozzle as per customer budget<br><br>

                                        <b>4.</b> If customer is looking for hygeine application then give SS 304 header with food grade hoses<br><br>

                                        <b>5.</b> For getting better clarity its always suggested with VFD operation (Not necessary and depends on customer budget)<br><br>

                                        <b>6.</b> Double filtration can be done for better clarity using HP 7022 and HP 650 GSM cloth<br><br>

                                        <b>7.</b> For smaller machines like 470 , 610 mm and 800 mm check ring type cloth and check ring  to be quoted for Pad cloth (HP 600 GSM)<br><br>

                                        <b>8.</b> Please check with production before you quote for any press avaiable in stock and quote the nearby range machine as per the sizing if the stock machine matches this enquiry <br><br>

                                        <b>9.</b> When quoting pump , the rotor and stator should be food grade and if budget don’t fit check with customer the contact parts <br><br>

                                        <b>10.</b> Check for temeprature , if its high temprature then high temeprature plate should be quoted
