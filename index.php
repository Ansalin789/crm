...
if(isset($_POST['submit']))
{
    $uname=$_POST['uname'];
    $pass=$_POST['pass'];
    $result=mysqli_query($db,"SELECT * FROM admin WHERE uname='$uname' AND pass='$pass'");
    if(mysqli_num_rows($result)>0){
    $_SESSION["uname"] = "$uname";
    $_SESSION["pass"] = "$pass";
    header ("location:ETP1.php");
        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark">
            <div x-data="auth">
                ...
                >
                    ...
                    >
                        <div
                            class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[10px] py-20"
                        >
                            <div class="mx-auto w-full max-w-[440px]">
                                ...
                                <form method="post">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative text-white-dark">
                                            <input type="text" name="uname" placeholder="Enter Username" class="form-input ps-10 placeholder:text-white-dark" />
                                ...
                                <div class="text-center dark:text-white">
                                    ...
                                    <a class="text-primary underline transition hover:text-black dark:hover:text-white"
                                        >Contact Admin</a
                                    >
                                </div>
                            </div>
