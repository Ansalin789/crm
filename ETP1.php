                            ...
                            <div class="mb-6 grid gap-8 xl:grid-cols-3">
                                <div class="panel h-full xl:col-span-2">
                                    ...
                                    <div class="space-y-5">
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div>
                                                <label for="gridEmail">CAPACITY OF SLUDGE PRODUCED (m3 /hr)</label>
                                                <input id="column1" type="text" name="one" placeholder="" class="form-input" />
                                            </div>
                                            <div>
                                                <label for="gridPassword">TOTAL NO. OF HOURS OF SLUDGE PRODUCTION (hrs)</label>
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div>
                                                <label for="gridEmail">CAPACITY OF SLUDGE PRODUCED (m3/day)</label>
                                                <input id="column3Value" name="three" type="text" placeholder="" class="form-input" />
                                            </div>
                                            <div>
                                                <label for="gridPassword">CAPACITY OF SLUDGE TO BE FILTERED PER DAY (ltrs)</label>
                                ...
                                const column9Input = document.getElementById("column9Value");
                                const column10Input = document.getElementById("column10Value");
                                ...
                                column9Input.addEventListener("input", updateEleventhColumn);
                                column10Input.addEventListener("input", updateEleventhColumn);
                                ...
                                updateEighthColumn(); // Also update Column 8 when updating Column 7
                                } else {column7Value.value = "";column8Value.value = "";}}
                                ...
                                const column9ValueNumber = parseFloat(column9Input.value);
                                const column10ValueNumber = parseFloat(column10Input.value);
                                ...
                                // Add logic to fetch the values from the relevant input fields
                                const column3ValueNumber = parseFloat(column3Value.value);
                                const percentageValue = parseFloat(percentageInput.value);
                                const column6ValueNumber = parseFloat(column6Input.value);
                                const column2ValueNumber = parseFloat(column2Input.value);
                                const column4ValueNumber = parseFloat(column4Value.value);
                                const column5ValueNumber = parseFloat(column5Value.value);
                                const column7ValueNumber = parseFloat(column7Value.value);

                                if (!isNaN(column8ValueNumber) && !isNaN(column11ValueNumber) && column11ValueNumber !== 0) {
                                    const twelfthValue = column8ValueNumber / column11ValueNumber;

                                    // Update column12Value based on additional input fields
                                    if (!isNaN(column3ValueNumber) && !isNaN(percentageValue) && !isNaN(column6ValueNumber) &&
                                        !isNaN(column2ValueNumber) && !isNaN(column4ValueNumber) && !isNaN(column5ValueNumber) && !isNaN(column7ValueNumber)) {
                                ...
                                <div class="panel h-full">
                                    ...
                                    <div class="overflow-hidden" style="Overflow-y:scroll; height: 850px;">
                                        <b>1.</b> Cloth suggested HP 7002  (10 to 15 microns)<br><br>

                                        <b>2.</b> Pump selection shall be 5-6 times the chamber volume . For example 500 liters is chamber volume then 500*6= 3000 so 3 m3/hr pump shall be  suggested, progressive screw pump can be given<br><br> 

                                        <b>3.</b> Check with client if its biological or chemcial treated and if its biological treated clearly mention in the offer the cake formation will have moisture above 70 % as the product is of slimy nature and to be conditioned using lime and some polyelctrolyte to be induced to ease filterability<br><br>

                                        <b>4.</b> If Ph is acidic , choose FRP lining and SS nozzle <br><br>

                                        <b>5.</b> For export projects consider DA hydraulics while submitting quote<br><br>

                                        <b>6.</b> please check with production before you quote for any press avaiable in stock and quote the nearby range machine as per the sizing if the stock machine matches this enquiry <br><br>

                                        <b>7.</b> Specific gravity/density above 3, consider top feed<br><br>

                                        <b>8.</b> For high temeprature above 60 degree consider high temeprature plates<br><br>

                                        <b>9.</b>  For abrasive slurry take advise of pump selection for stator and for sand slurry select centrifugal rubber lined pump<br><br>

                                        <b>10.</b> For zero lekage conditions, choose CGR plates<br><br>

                                        <b>11.</b>  Cake washing consider 4 corner type plates<br><br>

                                        <b>12.</b> Consider 32 mm cake thickness always<br><br>

                                        <b>13.</b>  If desnity is more than 2.5, top feed to be considered
