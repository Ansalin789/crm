                        ...
                        <div class="pt-5">
                            <div class="mb-6 grid gap-6 sm:grid-cols-2 xl:grid-cols-2">
                                <div class="panel h-full sm:col-span-2 xl:col-span-1">
                                    <?php
                                        ...
                                        {
                                         $val=$_POST['val'];
                                         $jet1 = mysqli_query($db,"UPDATE data SET 2nd='$val' WHERE id='1'");       
                                        }
                                    ?>
                                    <form method="post">
                                        <div class="grid grid-cols-3 sm:grid-cols-3 gap-2">
                                            ...
                                            ?>
                                            <div>
                                                <input type="text" name="val" id="divisorInput" value="<?php echo $row['2nd']; ?>" placeholder="" class="form-input" onchange="calculateColumns()"/>
                                            </div>
                                            <div>
                                    ...
                                    <div class="space-y-5">
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input id="column3Input" value="14" type="text" name="one" placeholder="" class="form-input" />
                                                <span class="mt-3" style="color:red">by default 14</span>
                                            </div>
                                            <div>
                               ...
                               <script>
                                    ...
                                    // Function to update all columns
                                    ...
                                    <div class="space-y-5">
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input id="column103Input" type="text" name="one" placeholder="" value="7%" class="form-input" />
                                                <span class="mt-3" style="color:red">6-7% generally</span>
                                            </div>
                                            <div>
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input id="column105Input" value="14" type="text" name="one" placeholder="" value="" class="form-input" />
                                                <span class="mt-3" style="color:red">DEFUALT IT IS 14</span>
                                            </div>
                                            <div>
                                ...
                                <script>
                                    ...
                                    function updateColumns() {
                                        ...
                                        if (!isNaN(column106Value)) {
                                            const resultColumn107 = (column106Value / 0.75).toFixed(2);
                            ...
                            <div class="mb-6 grid gap-6 sm:grid-cols-2 xl:grid-cols-2">
                                ...
                                <div class="panel h-full">
                                    ...
                                    <div class="overflow-hidden">
                                        <span style="color:red;"> 6-7 % stearine  percentage</span><br><br>
                                        ...
                                        <b>3.</b> 7 bar for 2nd frac or 16 bar can be quoted<br><br>

                                        <b>4.</b> extension if required can be given<br><br>

                                        <b>5.</b> (OLEIN CP-10-12; STEARIN IV 32-36), (SUPER OLEIN CP-6-8; STEARIN IV 42-46)
