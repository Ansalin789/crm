                            ...
                            <div class="mb-6 grid gap-8 xl:grid-cols-3">
                                <div class="panel h-full xl:col-span-2">
                                    ...
                                    <?php
                                        ...
                                        {
                                         $val=$_POST['val'];
                                         $jet1 = mysqli_query($db,"UPDATE data SET stp='$val' WHERE id='1'");       
                                        }
                                    ?>
                                    <form method="post">
                                        <div class="grid grid-cols-3 sm:grid-cols-3 gap-2">
                                            ...
                                            ?>
                                            <div>
                                                <input type="text" name="val" id="divisorInput" value="<?php echo $row['stp']; ?>" placeholder="" class="form-input" onchange="calculateColumns()"/>
                                            </div>
                                            <div>
                                    ...
                                    $three=$_POST['three'];
                                    $four=$_POST['four'];
                                    $jetone=mysqli_query($db,"INSERT INTO stp (one, two, three, four) VALUES('$one', '$two', '$three', '$four')");
                                    }
                                    ?>
                                    ...
                                    <div class="space-y-5">
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div>
                                                <label for="gridEmail">CAPACITY TO BE FILTERED PER DAY  IN M <sup>3</sup></label>
                                ...
                                const isTrue82 = column282ValueNumber <= 1;
                                ...
                                <div class="panel h-full">
                                    ...
                                    <div class="overflow-hidden" style="Overflow-y:scroll; height: 300px;">
                                        <b>1.</b> Cloth suggested HP 7022 ( 15 to 20 microns ) Pump selection shall be 5 times the chamber volume . For example 500 liters is chamber volume then 500*6= 300 so 3 m3/hr pump shall be  suggested, progressive screw pump can be given<br><br>

                                        <b>2.</b> Check with client if its biological or chemcial treated and if its biological treated clearly mention in the offer the cake formation will have moisture above 70 % as the product is of slimy nature <br><br> 

                                        <b>3.</b> Pump selection shall be 5 times the chamber volume . For example 500 liters is chamber volume then 500*5= 2500 so 2.5 m3/hr pump shall be  suggested<br><br>

                                        <b>4.</b> For export projects consider DA hydraulics while submitting quote<br><br>

                                        <b>5.</b> Please check with production before you quote for any press avaiable in stock and quote the nearby range machine as per the sizing if the stock machine matches this enquiry
                                    </div>
                                </div>
                            </div>
