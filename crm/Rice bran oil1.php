                            ...
                            <div class="mb-6 grid gap-8 xl:grid-cols-3">
                                <div class="panel h-full xl:col-span-2">
                                    <?php
                                        ...
                                        {
                                         $val=$_POST['val'];
                                         $jet1 = mysqli_query($db,"UPDATE data SET rbo1='$val' WHERE id='1'");       
                                        }
                                    ?>
                                    <form method="post">
                                        <div class="grid grid-cols-3 sm:grid-cols-3 gap-2">
                                            <div>
                                                <label for="gridEmail"><span style="color:green;font-family:san serif;">FILTRATION RATE / HR / M<sup>2</sup></span> <small>(Dewaxing)</small></label>
                                            </div>
                                            <?php
                                            ...
                                            ?>
                                            <div>
                                                <input type="text" name="val" id="divisorInput" value="<?php echo $row['rbo1']; ?>" placeholder="" class="form-input" onchange="updateThirdColumnInput()"/>
                                            </div>
                                            <div>
                                    ...
                                    <?php
                                        ...
                                        {
                                         $val=$_POST['val'];
                                         $jet1 = mysqli_query($db,"UPDATE data SET rbo2='$val' WHERE id='1'");       
                                        }
                                    ?>
                                    <form method="post">
                                        <div class="grid grid-cols-3 sm:grid-cols-3 gap-2">
                                            <div>
                                                <label for="gridEmail"><span style="color:green;font-family:san serif;">FILTRATION RATE / HR / M<sup>2</sup></span> <small>(Winterisation)</small></label>
                                            </div>
                                            <?php
                                            $jets=mysqli_query($db,"SELECT * FROM data WHERE id='1'");
                                            $row=mysqli_fetch_array($jets);
                                            ?>
                                            <div>
                                                <input type="text" name="val" id="divisorInput1" value="<?php echo $row['rbo2']; ?>" placeholder="" class="form-input" onchange="updateFifthColumnInput()"/>
                                            </div>
                                            <div>
                                                <button type="submit" name="set1" class="btn btn-primary">Set</button> 
                                            </div>
                                        </div>
                                    </form>
                                    ...
                                    <div class="space-y-5">
                                        ...
                                        <br>
                                       <u><h2>Dewaxing Rice bran oil</h2></u>
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div>
                                                <label for="gridEmail">CAPACITY TO BE FILTERED PER DAY (TPD)</label>
                                                <input id="column2" type="text" name="one" placeholder="" class="form-input" />
                                            </div>
                                            <div>
                                                <label for="gridPassword">NUMBER OF MACHINES</label>
                                                <input id="column3Input" type="text" name="two" value="" placeholder="" class="form-input"/>
                                                <span id="column3Message" class="error-message mt-2">2 standby can be suggested</span>
                                            </div>
                                        </div>

                                        <br><br>

                                       <u><h2> Winterisation  Rice bran oil</h2></u>
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div>
                                                <label for="gridEmail">FILTER PRESS OPERATING HOURS </label>
                                                <input id="column4" name="three" type="text" placeholder="" class="form-input" />
                                            </div>
                                            <div>
                                                <label for="gridPassword">FILTRATION REQUIRED BY CLIENT  PER HOUR </label>
                                                <input id="column5Input" name="four" type="text" placeholder="" class="form-input" />
                                                <span id="column5Message" class="error-message mt-2">2 standby can be suggested </span>
                                            </div>
                                        </div>
                                ...
                                <script>
                                    ...
                                    const column3Message = document.getElementById("column3Message");

                                    // Hide the message by default
                                    column3Message.style.display = "none";

                                    // Add event listener to update column 3 input box
                                    column2Input.addEventListener("input", updateThirdColumnInput);

                                    // Function to update column 3 input box
                                    function updateThirdColumnInput() {
                                        const column2Value = parseFloat(column2Input.value);
                                        // Assuming you have a "divisorInput" input field
                                        ...
                                        if (!isNaN(column2Value)) {
                                            const result = Math.ceil(column2Value / divisorInputValue);
                                            column3Input.value = result.toFixed(); // Set the value of column 3 input box

                                            if (result >= 6) {
                                                // Display a message when more than 6 machines are selected
                                                column3Message.style.display = "block";
                                            } else {
                                                // Clear any custom validation message
                                                column3Message.style.display = "none";
                                            }
                                        } else {
                                            column3Input.value = ""; // Clear column 3 input box if the input is not a valid number
                                            column3Message.style.display = "none"; // Clear any custom validation message
                                        }
                                    }
                                    ...
                                    const column5Message = document.getElementById("column5Message");

                                    // Hide the messages by default
                                    column5Message.style.display = "none";

                                    // Add event listener to update column 5 input box
                                    column4Input.addEventListener("input", updateFifthColumnInput);

                                    // Function to update column 5 input box
                                    function updateFifthColumnInput() {
                                        const column4Value = parseFloat(column4Input.value);
                                        const divisorInput1 = document.getElementById("divisorInput1");
                                        const divisorInputValue1 = parseFloat(divisorInput1.value);
                                        if (!isNaN(column4Value)) {
                                            const result = Math.ceil(column4Value / divisorInputValue1);
                                            column5Input.value = result.toFixed(); // Set the value of column 5 input box

                                            if (result >= 6) {
                                                // Display the message when the result exceeds 6 and show the <span>
                                                column5Message.style.display = "block";
                                            } else {
                                                // Hide the message if the result is 6 or less
                                                column5Message.style.display = "none";
                                            }
                                        } else {
                                            column5Input.value = ""; // Clear column 5 input box if the input is not a valid number
                                            // Hide the message if the input is not valid
                                            column5Message.style.display = "none";
                                        }
                                    }
                                </script>
                                ...
                                <div class="panel h-full">
                                    ...
                                    <div class="overflow-hidden" style="Overflow-y:scroll; height: 300px;">
                                        ...
                                        <b>4.</b> Please check with production before you quote for any press available in stock and quote the nearby range machine as per the sizing if the stock machine matches this enquiry 
                                    ...
                                    <div class="overflow-hidden">
                                        <div class="table-responsive">
                                            <table>
                                                ...
                                                <tbody>
                                                        <tr>
                                                            <td>If 470 * 470 mm number of plates requried is <span style="color:green;" class="text-md font-bold" id=""></span></td>
                                                            <td><span style="color:blue;" class="text-lg font-bold" id=""></span></td>
                                                            <td><span id=""></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td>If 610 * 610 mm number of plates requried is <span style="color:green;" class="text-md font-bold" id=""></span></td>
                                                            <td><span style="color:blue;" class="text-lg font-bold" id=""></span></td>
                                                            <td><span id=""></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td>If 800 * 800 mm number of plates requried is <span style="color:green;" class="text-md font-bold" id=""></span></td>
                                                            <td><span style="color:blue;" class="text-lg font-bold" id=""></span></td>
                                                            <td><span id=""></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td>If 915 * 915 mm number of plates requried is <span style="color:green;" class="text-md font-bold" id=""></span></td>
                                                            <td><span style="color:blue;" class="text-lg font-bold" id=""></span></td>
                                                            <td><span id=""></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td>If 1000 * 1000 mm number of plates requried is <span style="color:green;" class="text-md font-bold" id=""></span></td>
                                                            <td><span style="color:blue;" class="text-lg font-bold" id=""></span></td>
                                                            <td><span id=""></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td>If 1100 * 1100 mm number of plates requried is <span style="color:green;" class="text-md font-bold" id=""></span></td>
                                                            <td><span style="color:blue;" class="text-lg font-bold" id=""></span></td>
                                                            <td><span id=""></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td>If 1200 * 1200 mm number of plates requried is <span style="color:green;" class="text-md font-bold" id=""></span></td>
                                                            <td><span style="color:blue;" class="text-lg font-bold" id=""></span></td>
                                                            <td><span id=""></span></td>
                                                        </tr>
                                                        <tr>
