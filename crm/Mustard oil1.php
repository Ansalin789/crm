                            ...
                            <div class="mb-6 grid gap-8 xl:grid-cols-3">
                                <div class="panel h-full xl:col-span-2">
                                    <?php
                                        ...
                                        {
                                         $val=$_POST['val'];
                                         $jet1 = mysqli_query($db,"UPDATE data SET mo='$val' WHERE id='1'");       
                                        }
                                    ?>
                                    <form method="post">
                                        <div class="grid grid-cols-3 sm:grid-cols-3 gap-2">
                                            ...
                                            ?>
                                            <div>
                                                <input type="text" name="val" id="divisorInput" value="<?php echo $row['mo']; ?>" placeholder="" class="form-input" onchange="calculateColumns()"/>
                                            </div>
                                            <div>
                                ...
                                <div class="panel h-full">
                                    ...
                                    <div class="overflow-hidden" style="Overflow-y:scroll; height: 300px;">
                                        ...
                                        <b>4.</b>  check ring  to be quoted with or without the cloth<br><br>
                                        <b>5.</b> Please check with production before you quote for any press available in stock and quote the nearby range machine as per the sizing if the stock machine matches this enquiry <br><br>
                                        <b>6.</b> Check for temeprature , if its high temprature then high temeprature plate should be quoted
