                        ...
                        <div class="pt-5">
                            <div class="mb-6 grid gap-6 sm:grid-cols-2 xl:grid-cols-2">
                                <div class="panel h-full sm:col-span-2 xl:col-span-1">
                                    <?php
                                        ...
                                        {
                                         $val=$_POST['val'];
                                         $jet1 = mysqli_query($db,"UPDATE data SET 30barp='$val' WHERE id='1'");       
                                        }
                                    ?>
                                    <form method="post">
                                        <div class="grid grid-cols-3 sm:grid-cols-3 gap-2">
                                            ...
                                            ?>
                                            <div>
                                                <input type="text" name="val" id="divisorInput" value="<?php echo $row['30barp']; ?>" placeholder="" class="form-input" onchange="calculateColumns()"/>
                                            </div>
                                            <div>
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <label for="gridPassword">DENSITY</label>
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div>
                                                <label for="gridEmail">CAPACITY FILTERED PER (ltrs)</label>
                                                <input id="column3Value" type="text" name="one" placeholder="" class="form-input" />
                                            </div>
                                            <div>
                                                <label for="gridPassword">CAPACITY FILTERED PER (ltrs)</label>
                                                <input id="column4Value" type="text" name="two" value="" placeholder="" class="form-input"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input id="column5" value="18" type="text" name="one" placeholder="" class="form-input" />
                                                <span class="mt-3" style="color:red">by default 18</span>
                                            </div>
                                            <div>
                                                <label for="gridPassword">CAPACITY FILTERED IN EACH CYCLE</label>
                                                <input id="column6Value" type="text" name="two" value="" placeholder="" class="form-input"/>
                                            </div>
                                        </div>

                                        <div class="col-md-6">
                                            <label for="ctnEmail">EFFICIENCY 75%</label>
                                            <input id="column7Value" type="text" name="thirteen" placeholder="" class="form-input" required readonly/>
                                        </div>
                               ...
                               <script>
                                    const elements = {
                                        column1Input: document.getElementById("column1"),
                                        column2Input: document.getElementById("column2"),
                                        column3Value: document.getElementById("column3Value"),
                                        column4Value: document.getElementById("column4Value"),
                                        column5Input: document.getElementById("column5"),
                                        column6Value: document.getElementById("column6Value"),
                                        column7Value: document.getElementById("column7Value")
                                    };

                                    const updateColumns1 = () => {
                                        const { column1Input, column2Input, column3Value, column4Value, column5Input, column6Value, column7Value } = elements;

                                        const column1Value = parseFloat(column1Input.value);
                                        const column2Value = parseFloat(column2Input.value);
                                        const column5Value = parseFloat(column5Input.value);

                                        const divisionValue = column2Value !== 0 ? (column1Value / column2Value) : "Cannot divide by zero";
                                        column3Value.value = !isNaN(divisionValue) ? divisionValue : "";

                                        const multiplicationResult = column3Value.value * 1000;
                                        column4Value.value = !isNaN(multiplicationResult) ? multiplicationResult : "";

                                        const divisionResult = column5Value !== 0 ? (column4Value.value / column5Value) : "Cannot divide by zero";
                                        column6Value.value = !isNaN(divisionResult) ? divisionResult : "";

                                        const seventhColumnResult = column6Value.value / 0.75;
                                        column7Value.value = !isNaN(seventhColumnResult) ? seventhColumnResult : "";
                                    };

                                    for (const key in elements) {
                                        if (elements.hasOwnProperty(key)) {
                                            elements[key].addEventListener("input", updateColumns1);
                                        }
                                    }

                                    updateColumns1(); // Initial calculation

                                    function calculateColumns() {
                                        const column7InputNumber = parseFloat(column7Value.value);
                                        const divisorInputValue = parseFloat(divisorInput.value);
                                        const column13ValueNumber = Math.ceil(column7InputNumber /(divisorInputValue * 2.3));
                                        const column14ValueNumber = Math.ceil(column7InputNumber /(divisorInputValue * 3.5));

                                        const column15ValueNumber = Math.ceil(column13ValueNumber / 92);
                                        const column16ValueNumber = Math.ceil(column14ValueNumber / 101);

                                        const isTrue1 = column15ValueNumber <= 1;
                                        const isTrue2 = column16ValueNumber <= 1;
                                            ...
                                            <table>
                                                ...
                                                <tbody>
                                                        <tr>
                                                            ...
                                                            <td><span style="color:blue;" class="text-lg font-bold" id="column15Value"></span></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span style="color:blue;" class="text-lg font-bold" id="column16Value"></span></td>
                            ...
                            <div class="mb-6 grid gap-6 sm:grid-cols-2 xl:grid-cols-2">
                                        ...
                                        <div class="space-y-5">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <input id="column103Input" type="text" name="one" placeholder="" value="35%" class="form-input" />
                                                    <span class="mt-3" style="color:red">35% generally</span>
                                                </div>
                                                <div>
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <input id="column105Input" value="18" type="text" name="one" placeholder="" value="" class="form-input" />
                                                    <span class="mt-3" style="color:red">DEFUALT IT IS 18</span>
                                                </div>
                                                <div>
                                ...
                                <script>
                                    ...
                                    let column104Value = NaN;
                                    let column106Value = NaN;
                                    
                                    // Add event listener to update column 6 and column 7 input boxes
                                    column106Input.addEventListener("input", function () {
                                        column106Value = parseFloat(column106Input.value);
                                        updateColumns();
                                    });
                                ...
                                function calculateColumns1() {
                                        ...
                                        const column130ValueNumber = Math.ceil(column107InputNumber /23);
                                        const column140ValueNumber = Math.ceil(column107InputNumber /60);

                                        //40mm
                                        const column150ValueNumber = Math.ceil(column130ValueNumber /92);
                                        const column160ValueNumber = Math.ceil(column140ValueNumber /101);


                                        const isTrue10 = column150ValueNumber <= 1;
                                        const isTrue20 = column160ValueNumber <= 1;
                                    ...
                                    <div class="overflow-hidden">
                                       <div class="table-responsive">
                                            <table>
                                                ...
                                                <tbody>
                                                        <tr>
                                                            <td>Select 1250 * 1250  mm number of plates requried is  <span style="color:green;" class="text-md font-bold" id="column130Value"></span></td>
                                                            <td><span style="color:blue;" class="text-lg font-bold" id="column150Value"></span></td>
                                                            <td><span id="columnValue10Output"></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Select 1500 * 1500  mm number of plates requried is  <span style="color:green;" class="text-md font-bold" id="column140Value"></span></td>
                                                            <td><span style="color:blue;" class="text-lg font-bold" id="column160Value"></span></td>
