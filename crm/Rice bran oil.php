                        ...
                        <div class="pt-5">
                            <div class="mb-6 grid gap-8 xl:grid-cols-3">
                                <div class="panel h-full xl:col-span-2">
                                    ...
                                    ?>
                                    <div id="hide">
                                        <input type="text" id="divisorInput" value="<?php echo $row['rbo1']; ?>" placeholder="" class="form-input" onchange="updateThirdColumnInput()"/>

                                        <input type="text" id="divisorInput1" value="<?php echo $row['rbo2']; ?>" placeholder="" class="form-input" onchange="updateFifthColumnInput()"/>
                                    </div>
                                       ...
                                       <u><h2>Dewaxing Rice bran oil</h2></u>
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <span id="column3Message" class="error-message">2 standby can be suggested</span>
                                            </div>
                                        </div>
                                       ...
                                       <u><h2> Winterisation  Rice bran oil</h2></u>
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <span id="column5Message" class="error-message">2 standby can be suggested</span>
                                            </div>
                                        </div>
