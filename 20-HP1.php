                    ...
                    <div x-data="sales">
                        <ul class="flex space-x-2 rtl:space-x-reverse">
                            ...
                            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                                <span>20 bar High Pressure machineRBO</span>
                            </li>
                        </ul>
                            ...
                            <div class="mb-6 grid gap-8 xl:grid-cols-3">
                                <div class="panel h-full xl:col-span-2">
                                    <?php
                                        ...
                                        {
                                         $val=$_POST['val'];
                                         $jet1 = mysqli_query($db,"UPDATE data SET 20bar='$val' WHERE id='1'");       
                                        }
                                    ?>
                                    <form method="post">
                                        <div class="grid grid-cols-3 sm:grid-cols-3 gap-2">
                                            ...
                                            ?>
                                            <div>
                                                <input type="text" name="val" id="divisorInput" value="<?php echo $row['20bar']; ?>" placeholder="" class="form-input" onchange="calculateColumns()"/>
                                            </div>
                                            <div>
                                    ...
                                    <div class="space-y-5">
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <label for="gridPassword">FILTRATION REQUIRED BY CLIENT  PER HOUR (ltrs)</label>
                                ...
                                const column23ValueNumber = Math.ceil(column15ValueNumber / 60);
                                const column24ValueNumber = Math.ceil(column16ValueNumber / 90);
                                const column25ValueNumber = Math.ceil(column17ValueNumber / 100);
                                const column26ValueNumber = Math.ceil(column18ValueNumber / 90);
                                ...
                                const column230ValueNumber = Math.ceil(column150ValueNumber / 60);
                                const column240ValueNumber = Math.ceil(column160ValueNumber / 90);
                                const column250ValueNumber = Math.ceil(column170ValueNumber / 100);
                                const column260ValueNumber = Math.ceil(column180ValueNumber / 90);
                                ...
                                const isTrue3 = column15ValueNumber <= 60;
                                const isTrue4 = column16ValueNumber <= 90;
                                const isTrue5 = column17ValueNumber <= 100;
                                const isTrue6 = column18ValueNumber <= 90;
                                const isTrue7 = column19ValueNumber <= 120;
                                const isTrue8 = column20ValueNumber <= 120;
                                const isTrue82 = column202ValueNumber <= 120;

                                //40
                                const isTrue10 = column130ValueNumber <= 30;
                                const isTrue20 = column140ValueNumber <= 40;
                                const isTrue30 = column150ValueNumber <= 60;
                                const isTrue40 = column160ValueNumber <= 90;
                                const isTrue50 = column170ValueNumber <= 100;
                                const isTrue60 = column180ValueNumber <= 90;
                                const isTrue70 = column190ValueNumber <= 120;
                                const isTrue80 = column200ValueNumber <= 120;
                                ...
                                <div class="panel h-full">
                                    ...
                                    <div class="overflow-hidden" style="Overflow-y:scroll; height: 300px;">
                                        <b>1.</b> Cloth suggested HP 7034 or PO 600 GSM <br><br>
                                        ...
                                        <b>3.</b> Check ring  to be quoted or to be checked<br><br>
                                        ...
                                        <b>5.</b> Check for temeprature , if its high temprature then high temeprature plate should be quoted<br><br>
                                        <b>6.</b> Wax Input should be 30-35% wax and 70-65 % oil )
